...
abstract contract FlashBot is FlashSwapper, ReentrancyGuard {
    ...
    function flashArbitrage(address pool0, address pool1) external {
        ...
        // avoid stack too deep error
        {
            ...
            startSwap(info.quoteToken, info.baseToken, amount0Out, amount1Out, data);
        }
    }
    ...
    function execute(address _tokenBorrow, uint _amount, bytes memory _userData) internal { 
